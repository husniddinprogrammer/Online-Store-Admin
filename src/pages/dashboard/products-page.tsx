  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto">
      <PageHeader
        ...
        description={t("products.subtitle", { count: data?.totalElements ?? "..." })}
      >
        {canEdit && (
      ...
      <Card>
        <div className="flex gap-3 p-4 border-b border-border">
          ...
          >
            ...
            <SelectContent>
              <SelectItem value="ALL">
                {t("products.category")} — {t("common.noData").toLowerCase()}
              </SelectItem>
              {categories.map((c) => (
          ...
          >
            ...
            <SelectContent>
              <SelectItem value="ALL">
                {t("products.company")} — {t("common.noData").toLowerCase()}
              </SelectItem>
              {companies.map((c) => (
                <SelectItem key={c.id} value={String(c.id)}>
                  {c.name}
              ...
              <TableRow>
                <TableHead className="w-20">
                  ...
                  >
                    ...
                    {isSortActive("id") && (
                      <ChevronUp
                        className={`h-4 w-4 transition-transform ${isSortDesc("id") ? "rotate-180" : ""}`}
                      />
                    )}
                  </button>
                </TableHead>
                ...
                <TableHead>
                  ...
                  >
                    ...
                    {isSortActive("price") && (
                      <ChevronUp
                        className={`h-4 w-4 transition-transform ${isSortDesc("price") ? "rotate-180" : ""}`}
                      />
                    )}
                  </button>
                </TableHead>
                <TableHead>
                  ...
                  >
                    ...
                    {isSortActive("discount") && (
                      <ChevronUp
                        className={`h-4 w-4 transition-transform ${isSortDesc("discount") ? "rotate-180" : ""}`}
                      />
                    )}
                  </button>
                </TableHead>
                <TableHead className="hidden md:table-cell">
                  ...
                  >
                    ...
                    {isSortActive("stock") && (
                      <ChevronUp
                        className={`h-4 w-4 transition-transform ${isSortDesc("stock") ? "rotate-180" : ""}`}
                      />
                    )}
                  </button>
                </TableHead>
                <TableHead>
                  ...
                  >
                    ...
                    {isSortActive("sold") && (
                      <ChevronUp
                        className={`h-4 w-4 transition-transform ${isSortDesc("sold") ? "rotate-180" : ""}`}
                      />
                    )}
                  </button>
                </TableHead>
              ...
              <div className="space-y-1.5">
                ...
                <Input
                  ...
                  onChange={(e) => {
                    ...
                    setValue("sellPrice", parseFormattedNumber(formatted), {
                      shouldValidate: true,
                    });
                  }}
                />
              ...
              <div className="space-y-1.5">
                ...
                <Input
                  ...
                  onChange={(e) => {
                    ...
                    setValue("arrivalPrice", parseFormattedNumber(formatted), {
                      shouldValidate: true,
                    });
                  }}
                />
              ...
              <div className="space-y-1.5">
                ...
                <Input
                  ...
                  onChange={(e) => {
                    ...
                    setValue("stockQuantity", parseFormattedNumber(formatted), {
                      shouldValidate: true,
                    });
                  }}
                />
              ...
              <div className="space-y-1.5">
                ...
                <Input
                  ...
                  onChange={(e) => {
                    ...
                    setValue("discountPercent", parseFormattedNumber(formatted), {
                      shouldValidate: true,
                    });
                  }}
                />
      ...
      {/* Image Upload Dialog */}
      <Dialog
        open={!!imageUploadProduct}
        onOpenChange={(open) => !open && setImageUploadProduct(null)}
      >
        <DialogContent
        ...
        >
          <DialogHeader>
            <DialogTitle>
              {t("products.uploadImages")} — {imageUploadProduct?.name}
            </DialogTitle>
          </DialogHeader>
          {imageUploadProduct && (
            <ProductImageUpload
