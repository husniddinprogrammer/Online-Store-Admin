  ...
  return (
    <div className="space-y-6 max-w-3xl mx-auto">
      <PageHeader
        ...
        description={
          unseenCount > 0 ? `${unseenCount} unread` : t("notifications.noNotificationsDesc")
        }
      >
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-start gap-2 mb-1">
                      <Badge
                        variant={typeVariant[notif.type] ?? "secondary"}
                        className="text-[10px]"
                      >
                        {notif.type}
                      </Badge>
                    ...
                    <p
                      className={cn(
                        "text-sm",
                        !notif.isSeen ? "text-foreground font-medium" : "text-muted-foreground",
                      )}
                    >
                      {notif.text}
                    </p>
