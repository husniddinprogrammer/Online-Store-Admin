...
import type { ApiResponse, PaginatedResponse, Product, ProductQueryParams, ProductRequest } from "@/types";

export const productsService = {
  getAll: async (params?: ProductQueryParams) => {
    const { data } = await api.get<ApiResponse<PaginatedResponse<Product>>>("/api/products", { params });
    return data.data;
  },
